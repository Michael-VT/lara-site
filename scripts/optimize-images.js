...
const productGroups = [
	...
	},
	{
		...
		items: {
			...
			// ⚠ sharp's .webp() under bun produced displacement-band artifacts
			// for this photo (see AGENTS.md "Known landmine"). The committed
			// webps were regenerated by running this same pipeline via plain
			// `node`, which is clean. If you ever re-run the optimizer, do it
			// via node (or visually verify every output afterwards).
